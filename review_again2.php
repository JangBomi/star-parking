...
<body>
  <form class="form-review" action="헌리뷰html_to_db.php" method="POST">
    <?php
    $parkingID_rg=$_POST['parkingID_ss'];
    echo $parkingID_rg;
     ?>
...
<section id="main_section">
<form><input name="review" type="text" size=50 placeholder="리뷰를 작성해주세요!">
<input type="submit" name="btn" value="작성"></form>
</section>

 <input name="parkingID_rrgg" value=<?php echo "$parkingID_rg" ?> >
