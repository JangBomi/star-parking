			...
			<div class="content grid_12 contactmap dn" id="contact-car">
				<div class="grid_4">
					...
					<p class="information">
						...
						<br>
						<div class="btn">
							<span class="icon-checkmark"></span> Car Park
						</div>
					</div>
					<div class="grid_8 omega">
							...
							<div class="col-lg-8 col-sm-10 center-block container">
								<form id="register-form" action="signUp.php" method="post">
									<div class="col-lg-8 col-sm-10 center-block">
										...
										<label>연락처</label><span class="status" id="phone-status"></span>
										<input type="tel" name="phone" placeholder="번호를 입력하세요" data-validation="len:0-15 regex:phone or:email:Email"/>
